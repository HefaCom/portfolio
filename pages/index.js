...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : "light"}>
      ...
      <main className="bg-white px-10 dark:bg-gray-900 max-w-md mx-auto sm:px-4 md:px-6 lg:px-8 xl:max-w-4xl">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="mx-auto bg-gradient-to-b from-teal-300 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-80 md:w-80 md:items-center md:justify-center">
