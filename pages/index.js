...
//         <span class="font-bold font-burtons text-xl">TheNerd</span> </a> 
//           </div>
//   <!-- primary nav -->
...
//   <a href="#" class="py-5 px-3 text-gray-700 hover:text-gray-900">Contact</a> </div>
//             </div> <!-- secondary nav -->
//             <div class="hidden md:flex items-center space-x-1">
...
//                />
//   </a> 
// //   <a href="" class="py-2 px-3 bg-yellow-400 text-white hover:bg-yellow-300 text-sm hover:text-yellow-800 rounded transition duration-300">Signup</a>
//                 </div> 
