    ...
    <div className="w-full ">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="mx-0 bg-gradient-to-b from-teal-300 rounded-lg w-80 h-80 relative overflow-hidden mt-20 md:h-80 md:w-80 md:flex md:items-center md:justify-center justify-center drop-shadow-2xl relative max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
