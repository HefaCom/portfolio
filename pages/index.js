    ...
    <div className="w-full">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="mx-auto bg-gradient-to-b from-teal-300 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-80 md:w-80 md:items-center md:justify-center flex justify-center">
